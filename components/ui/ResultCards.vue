  ...
  <div class="flex flex-wrap justify-between -ml-3 -mr-3">
    <div class="w-6/12 md:w-4/12 lg:max-w-[350px] px-3 pb-5">
      <div class="px-3 py-4 relative bg-gray-800 rounded-2xl">
        ...
        <div
          class="w-3 h-14 absolute right-0 top-1/2 transform -translate-y-1/2 rounded-tl-lg rounded-bl-lg bg-linear-to-b from-blue-900 to-blue-500"
        ></div>
      </div>
    </div>
    <div class="w-6/12 md:w-4/12 lg:max-w-[350px] px-3 pb-5">
      <div class="px-3 py-4 relative bg-gray-800 rounded-2xl">
        ...
        <div
          class="w-3 h-14 absolute right-0 top-1/2 transform -translate-y-1/2 rounded-tl-lg rounded-bl-lg bg-linear-to-b from-violet-900 to-violet-500"
        ></div>
      </div>
    </div>
    <div class="w-6/12 md:w-4/12 lg:max-w-[350px] px-3 pb-5">
      <div class="px-3 py-4 relative bg-gray-800 rounded-2xl">
        ...
        <div
          class="w-3 h-14 absolute right-0 top-1/2 transform -translate-y-1/2 rounded-tl-lg rounded-bl-lg bg-linear-to-b from-teal-700 to-teal-400"
        ></div>
      </div>
    </div>
  </div>
